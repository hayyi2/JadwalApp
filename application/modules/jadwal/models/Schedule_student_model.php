...
class Schedule_student_model extends CRUD_Model {
	protected $table_name = "schedule_student";
	protected $table_view_name = 'schedule_student_view';
	protected $primary_key = "schedule_student_id";
