						...
						<div class="card">
							...
							<div class="card-body pb-0">
								<div class="form-group row">
									...
									<div class="col-sm-8">
										<input name="full_name" value="<?php echo $data->full_name; ?>" required="" type="text" class="form-control" placeholder="Nama Lengkap">
									</div>
								</div>
								<div class="form-group row">
									<label class="col-sm-4 col-form-label">Nama Panggilan</label>
									<div class="col-sm-8">
										<input name="nick_name" value="<?php echo $data->nick_name; ?>" required="" type="text" class="form-control" placeholder="Nama Panggilan">
									</div>
								</div>
								<div class="form-group row">
